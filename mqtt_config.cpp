                      ...
                      mqtt_config_t* config)
{
    ...
    version.t = NEU_JSON_INT;
    version.v.val_int = NEU_MQTT_VERSION_V311;
    version.attribute = NEU_JSON_ATTRIBUTE_OPTIONAL;
    neu_json_elem_t client_id = {.name = "client-id", .t = NEU_JSON_STR};
    neu_json_elem_t qos;
    qos.name = "qos";
    qos.t = NEU_JSON_INT;
    qos.v.val_int = NEU_MQTT_QOS0;
    qos.attribute = NEU_JSON_ATTRIBUTE_OPTIONAL;
    ...
    offline_cache.t = NEU_JSON_BOOL;

    neu_json_elem_t cache_mem_size;
    cache_mem_size.name = "cache-mem-size";
    cache_mem_size.t = NEU_JSON_INT;

    neu_json_elem_t cache_disk_size;
    cache_disk_size.name = "cache-disk-size";
    cache_disk_size.t = NEU_JSON_INT;

    neu_json_elem_t cache_sync_interval;
    cache_sync_interval.name = "cache-sync-interval";
    cache_sync_interval.t = NEU_JSON_INT;
    ...
    // neu_json_elem_t south_node_need_num = {.name = "south_node_need_num", .t = NEU_JSON_INT};
    ...
    neu_json_elem_t upload_drv_state;
    upload_drv_state.name = "upload_drv_state";
    upload_drv_state.t = NEU_JSON_BOOL;
    upload_drv_state.v.val_bool = false;
    upload_drv_state.attribute = NEU_JSON_ATTRIBUTE_OPTIONAL;

    neu_json_elem_t upload_drv_state_topic = {
        .name = "upload_drv_state_topic",
        .t = NEU_JSON_STR
    };
    neu_json_elem_t upload_drv_state_interval = {
    ...
    config->version = static_cast<neu_mqtt_version_e>(version.v.val_int);
